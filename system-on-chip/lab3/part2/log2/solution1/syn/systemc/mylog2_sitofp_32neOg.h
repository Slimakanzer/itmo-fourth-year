...
// ==============================================================
#ifndef __mylog2_sitofp_32neOg__HH__
#define __mylog2_sitofp_32neOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(mylog2_sitofp_32neOg) {
    ...
    SC_CTOR(mylog2_sitofp_32neOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
