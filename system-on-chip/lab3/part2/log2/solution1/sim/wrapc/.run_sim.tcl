...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mylog2.autotvin.dat"
	set constFileTvOut       "mylog2.autotvout.dat"
	set constFileHdlTvIn     "mylog2.autohdltvin.dat"
	set constFileHdlTvOut    "mylog2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
