...
// ==============================================================
#ifndef __mylog2_uitofp_32ndEe__HH__
#define __mylog2_uitofp_32ndEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(mylog2_uitofp_32ndEe) {
    ...
    SC_CTOR(mylog2_uitofp_32ndEe):  ACMP_uitofp_U ("ACMP_uitofp_U") {
