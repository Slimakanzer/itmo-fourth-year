...
// ==============================================================
#ifndef __mylog2_mul_42ns_4fYi__HH__
#define __mylog2_mul_42ns_4fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mylog2_mul_42ns_4fYi) {
    ...
    SC_CTOR(mylog2_mul_42ns_4fYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
