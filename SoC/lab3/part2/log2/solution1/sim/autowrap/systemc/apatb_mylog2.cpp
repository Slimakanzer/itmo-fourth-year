...
// tvout file define: "y"
#define AUTOTB_TVOUT_PC_y  "../tv/rtldatafile/rtl.mylog2.autotvout_y.dat"
...
extern "C" void mylog2 (
float x,
float* y);

extern "C" void AESL_WRAP_mylog2 (
float x,
float* y)
{
					...
					// bitslice(31, 0)
					{
						...
						// celement: y(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								if (&(y[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&y[i_0] = (y_lv0_0_0_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
