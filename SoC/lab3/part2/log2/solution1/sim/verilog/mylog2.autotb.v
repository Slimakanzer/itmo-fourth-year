...
`define AUTOTB_DUT      mylog2
`define AUTOTB_DUT_INST AESL_inst_mylog2
`define AUTOTB_TOP      apatb_mylog2_top
`define AUTOTB_LAT_RESULT_FILE "mylog2.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mylog2.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mylog2_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_x 1
`define AESL_DEPTH_y 1
`define AUTOTB_TVIN_x  "../tv/cdatafile/c.mylog2.autotvin_x.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.mylog2.autotvin_x.dat"
`define AUTOTB_TVOUT_y  "../tv/cdatafile/c.mylog2.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "../tv/rtldatafile/rtl.mylog2.autotvout_y.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 600;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 99;
