...
//------------------------Parameter----------------------
`define TV_IN_a "../tv/cdatafile/c.mul.autotvin_a.dat"
`define TV_IN_b "../tv/cdatafile/c.mul.autotvin_b.dat"
`define TV_OUT_c "../tv/rtldatafile/rtl.mul.autotvout_c.dat"
parameter ADDR_WIDTH = 12;
parameter DATA_WIDTH = 32;
parameter a_DEPTH = 100;
reg [31 : 0] a_OPERATE_DEPTH = 0;
parameter a_c_bitwidth = 32;
parameter b_DEPTH = 100;
reg [31 : 0] b_OPERATE_DEPTH = 0;
parameter b_c_bitwidth = 32;
parameter c_DEPTH = 100;
reg [31 : 0] c_OPERATE_DEPTH = 0;
parameter c_c_bitwidth = 32;
parameter a_data_in_addr = 512;
parameter b_data_in_addr = 1024;
parameter n_data_in_addr = 2048;
parameter c_data_out_addr = 1536;
...
assign TRAN_AXILiteS_read_data_finish = 1 & c_read_data_finish;
