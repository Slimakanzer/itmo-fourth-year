...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { a_V_TDATA { I 32 vector } a_V_TVALID { I 1 bit } a_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { b_V_TDATA { I 32 vector } b_V_TVALID { I 1 bit } b_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { c_V_TDATA { O 32 vector } c_V_TVALID { O 1 bit } c_V_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { n_TDATA { I 32 vector } n_TVALID { I 1 bit } n_TREADY { O 1 bit } } \
} "
} else {
