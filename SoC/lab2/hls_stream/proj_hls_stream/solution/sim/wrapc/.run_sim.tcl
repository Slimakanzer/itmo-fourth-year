...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mul.autotvin.dat"
	set constFileTvOut       "mul.autotvout.dat"
	set constFileHdlTvIn     "mul.autohdltvin.dat"
	set constFileHdlTvOut    "mul.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
