...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "20", "EstimateLatencyMax" : "722",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.a_cache_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.b_cache_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	mul {
		a_V {Type I LastRead 10 FirstWrite -1}
		b_V {Type I LastRead 10 FirstWrite -1}
		c_V {Type O LastRead -1 FirstWrite 15}
		n {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "20", "Max" : "722"}
	, {"Name" : "Interval", "Min" : "21", "Max" : "723"}
]}
